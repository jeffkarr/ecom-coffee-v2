...
const TeasPage = () => {
  ...
  const onAddTeaToCart = (e) => {
    e.preventDefault();
    // let cartTeaItemId = e.target.id;
    // let cartTeaItemQty = useState(teaQty);
    // let tempCartItem = teas.filter(
    //   teaItem => teaItem.id === cartTeaItemId
    // );
  ...
  const onAddTeaToWish = (e) => {
    // e.preventDefault();
    // let wishTeaItemId = e.target.id;
    // let wishTeaItemQty = useState(teaQty);
